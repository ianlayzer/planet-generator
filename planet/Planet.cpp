    ...
    m_onlyShowOneFace(planetSettings.onlyShowOneFace)
{
    ...
    if (m_onlyShowOneFace) {
        ...
        m_faces[0] = std::make_unique<TerrainFace>(m_resolution, glm::vec3(0.f, 0.f, 1.f), m_continentNoise.get(), m_mountainNoise.get(), planetSettings.noiseSettings.useContinentsAsMask);
    } else {
